...
def loop_function(experiment_label, all_directories, num_repetitions, middlewares, client_logfiles, warmup_period_endtime, cooldown_period_starttime, sharded, outdir, num_threads, ylim_xput, ylim_resp, xlim):
    ...
    requestTypeName = ""
    if sharded == "sharded":
        requestTypeName = "ShardedGET"
    elif sharded == "nonsharded":
        requestTypeName = "NonshardedGET"

    averages = get_data(all_directories, num_repetitions, middlewares, client_logfiles, warmup_period_endtime, cooldown_period_starttime, num_threads, requestTypeName)
    ...
    plot_mw_memcachedRTT_all_workers(avg, experiment_label, workload, outdir, xlim)

def get_data(matching_dirs, num_repetitions, middlewares, client_logfiles, warmup_period_endtime, cooldown_period_starttime, num_threads, requestTypeName):
    ...
    for experiment_dir in matching_dirs:
        ...
        for rep in range(1, num_repetitions + 1):
            ...
            filtered_requests = [reqs[reqs['requestType']== requestTypeName] for reqs in concatenated_requests]
...
import matplotlib.pyplot as plt
import os, sys
exp5_dir = "/home/flo/Documents/eth-asl-final-experiment-data/exp5/5_1_multigets_sharded_2017-11-24_085912"
...
ylim_resp = 60
xlim = 420
create_workload_graphs(inputdir, experiment_label, "sharded", middlewares, client_logfiles, dir_suffix_regex_string, warmup_period_endtime, cooldown_period_starttime, outdir, num_threads, ylim_xput, ylim_resp, xlim)